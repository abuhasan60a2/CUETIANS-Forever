...
public class AlumniReg {
    ...
    private boolean formerror() {
        return studentid.getText() == "" | firstname.getText() == "" | lastname.getText() == "" | email.getText() == "" | password.getText() == "" |
                ...
                | joiningyear.getText() == "" |passingyear.getText()==""|profession.getText()==""| company.getText()==""|
                facebookprofile.getText() == "" | linkedinprofile.getText() == "";
    ...
    private boolean signupcheck() throws SQLException {
        ...
        PassingYear = passingyear.getText();
