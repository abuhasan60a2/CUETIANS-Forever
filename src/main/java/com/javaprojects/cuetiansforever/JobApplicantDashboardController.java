...
public class JobApplicantDashboardController implements Initializable {
    private Stage stage;
    private Scene scene;
    @FXML
    private Label name;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        studentid = Long.parseLong(resourceBundle.getString("CuetianID"));
...
//            throw new RuntimeException(e);
    ...
    public void return_to_list(ActionEvent event) throws IOException {
